    ...
    <fieldset id="updateSoftInput_form">
      ...
      <div>
        ...
        <input type="text" name="releaseDate"
          value="${fn:escapeXml(sessionInfo.updateSoft.releaseDate)}" style="width: 35%;">
      ...
      <div>
        ...
        <input type="text" name="price"
          value="${fn:escapeXml(sessionInfo.updateSoft.price)}" style="width: 25%; text-align: right;">
      ...
      <div>
        ...
        <input type="text" name="url"
          value="${fn:escapeXml(sessionInfo.updateSoft.url)}">
