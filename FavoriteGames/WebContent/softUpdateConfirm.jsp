    ...
    <fieldset id="updateSoftConfirm_form">
      ...
      <div>
        ...
        <input type="text" name="releaseDate"
               value="${fn:escapeXml(sessionInfo.updateSoft.releaseDate)}" readonly>
      </div>
      <div>
        <label class="item">価格　：</label>
        <input type="text" name="price"
               value="${fn:escapeXml(sessionInfo.updateSoft.price)}" readonly>
      </div>
      <div>
        <label class="item">URL　　：</label>
        <input type="text" name="url"
               value="${fn:escapeXml(sessionInfo.updateSoft.url)}" readonly>
      </div>
    </fieldset>
