      ...
      <fieldset id="updateSoftConfirm_form">
        <div>
          ...
          <input type="text" name="loginId"
                 value="${fn:escapeXml(sessionInfo.updateUser.loginId)}" readonly>
        </div>
        <div>
          <label class="item">ユーザ名：</label>
          <input type="text" name="userName"
                 value="${fn:escapeXml(sessionInfo.updateUser.userName)}" readonly>
        </div>
        <div>
          <label class="item">年代　：</label>
          <input type="text" name="age"
                 value="${fn:escapeXml(sessionInfo.updateUser.ageStr)}" readonly>
        </div>
        <div>
