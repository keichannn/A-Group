    ...
    <fieldset id="insertSoftConfirm_form">
      ...
      <div>
        ...
        <input type="text" name="genreStr"
               value="${fn:escapeXml(sessionInfo.registerSoft.genreStr)}" style="width: 40%;" readonly>
      </div>
      <div>
        <label class="item">機種　　：</label>
        <input type="text" name="modelStr"
               value="${fn:escapeXml(sessionInfo.registerSoft.modelStr)}" style="width: 20%;" readonly>
      </div>
            <div>
        <label class="item">発売日　：</label>
        <input type="text" name="releaseDate"
               value="${fn:escapeXml(sessionInfo.registerSoft.releaseDate)}" style="width: 25%;" readonly>
      </div>
      <div>
        <label class="item">価格　　：</label>
        <input type="text" name="price"
               value="${fn:escapeXml(sessionInfo.registerSoft.price)}" style="width: 25%; text-align: right;" readonly>
      </div>
      <div>
        <label class="item">URl　　：</label>
        <input type="text" name="url"
               value="${fn:escapeXml(sessionInfo.registerSoft.url)}" readonly>
      </div>
    </fieldset>
